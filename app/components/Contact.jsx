...
const Contact = ({ isDarkMode, setDarkMode }) => {
    ...
    return (
        <motion.div
            ...
            id="contact" className='w-full px-[12%] sm:px-12 py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")]
         ...
         dark:bg-none'>
            ...
            <motion.p
                ...
                Whether you have a question, a collaboration idea, or just want to connect,
                I'm here to help. Fill out the form below, and I'll be in touch soon!
            </motion.p>
