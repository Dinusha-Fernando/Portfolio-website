...
const Work = ({ isDarkMode, setDarkMode }) => {
    return (
        <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ duration: 1 }}
            id="work" className='w-full px-[12%] sm:px-12 py-10 scroll-mt-20'>

            <motion.h4
                initial={{ y: -20, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
                transition={{ delay: 0.3, duration: 0.5 }}
                className='text-center mb-2 text-base sm:text-lg font-Ovo dark:text-white/80'>
                My Portfolio
            </motion.h4>
            ...
            <motion.p
                ...
                Explore my latest projects showcasing my expertise in web and mobile development.
                From sleek UI designs to powerful cross-platform applications, each project reflects my
                    ...
                    <motion.div
                     ...
                     bg-cover bg-center rounded-lg relative cursor-pointer group'
                        ...
                        <div className='bg-white w-10/12  rounded-md absolute bottom-5
                         ...
                         items-center duration-500 group-hover:bottom-7 '>
                            <div>
